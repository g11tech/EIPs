...
The behavior of `BLOCKHASH` opcode remains same and doesn't affect backward compatibility with the contracts deployed or the gas consumption costs as the resolution of the opcode is handled "directly" by the clients
 ...
 * Active on verkle-gen-devet-4 for its verkle implementation
